...
export class Test1751616538370 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "back_in_stock" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "status" character varying NOT NULL, "email" character varying NOT NULL, "id" SERIAL NOT NULL, "productVariantId" integer NOT NULL, "channelId" integer NOT NULL, "customerId" integer, CONSTRAINT "PK_584ba1fca2a97ce6058a2aac3ad" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "back_in_stock" ADD CONSTRAINT "FK_7da16ab9da4898b39e7de52feee" FOREIGN KEY ("productVariantId") REFERENCES "product_variant"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "back_in_stock" ADD CONSTRAINT "FK_cf135a2242003b4afe40d40187b" FOREIGN KEY ("channelId") REFERENCES "channel"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "back_in_stock" ADD CONSTRAINT "FK_560713609370cb23301cb2d0768" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "back_in_stock" DROP CONSTRAINT "FK_560713609370cb23301cb2d0768"`, undefined);
        await queryRunner.query(`ALTER TABLE "back_in_stock" DROP CONSTRAINT "FK_cf135a2242003b4afe40d40187b"`, undefined);
        await queryRunner.query(`ALTER TABLE "back_in_stock" DROP CONSTRAINT "FK_7da16ab9da4898b39e7de52feee"`, undefined);
        ...
        await queryRunner.query(`DROP TABLE "back_in_stock"`, undefined);
